  ...
  return (
    <div className={cn(variant === "sticky" ? "flex gap-2" : "space-y-2")}>
      {phone ? (
        <a
          href={`tel:${phone}`}
          onClick={() => track(vehicleId, "call")}
          className={cn(primaryBtn, "bg-primary text-primary-foreground hover:bg-primary-hover", variant === "card" && "w-full")}
        >
      ...
      {whatsappUrl ? (
        <a
          ...
          className={cn(primaryBtn, "bg-success text-white hover:opacity-90", variant === "card" && "w-full")}
        >
      ...
      <Dialog>
        <DialogTrigger onClick={() => track(vehicleId, "enquire")} className={cn(enquireBtn, variant === "card" && "w-full")}>
