...
export function vehicleSchema(v: VehicleDetail, opts: { path: string; sellerName: string }) {
  ...
  return {
    ...
    ...(v.bodyType ? { bodyType: BODY_TYPE_LABELS[v.bodyType] } : {}),
    ...(v.fuelType ? { fuelType: FUEL_LABELS[v.fuelType] } : {}),
    ...(v.transmission ? { vehicleTransmission: TRANSMISSION_LABELS[v.transmission] } : {}),
