...
export const metadata = {
  ...
  description:
    "We don't have open positions right now, but we're always glad to hear from talented people who want to help local Australian rental operators grow.",
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-20 sm:py-28">
        ...
        <p className="mt-5 text-lg leading-relaxed text-slate-600">
          We&apos;re a small team focused on helping independent Australian car
          rental operators reach more customers. We don&apos;t have any open
          positions advertised at the moment.
        </p>
